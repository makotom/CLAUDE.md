...
**Ask for choice if there are options.** Never choose one arbitrarily. No self-exemptions: classifying a choice as "derivable from the context, the conversation, or the existing code" is itself my judgement, and my judgement of context is not trusted here - whatever I would pick on that basis is still my preference. Whenever options exist, I present them and ask.
